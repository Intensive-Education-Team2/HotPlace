...
public class PlaceInfoFoldableLayout extends RelativeLayout{
     ...
     */
    public PlaceInfoFoldableLayout(Context context) {
        super(context);
        setupView(context);
    }
     ...
     */
    public PlaceInfoFoldableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView(context);
    }
     ...
     */
    public PlaceInfoFoldableLayout(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public PlaceInfoFoldableLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void setupView(Context context) {
        ...
        mRootView = LayoutInflater.from(context).inflate(R.layout.place_info_foldable_layout, this, true);
    ...
    public void foldWithoutAnimation() {
        if (!mIsFolded && !mIsAnimating) {
            ...
            mViewGroupDetail.setVisibility(GONE);
            if (PlaceInfoFoldableLayout.this.getLayoutParams() != null) {
                PlaceInfoFoldableLayout.this.getLayoutParams().height = mCoverHeight;
            }
            requestLayout();
        }
    }
    ...
    public void unfoldWithoutAnimation() {
        if (mIsFolded && !mIsAnimating) {
            ...
            clearImageView(mImageViewBelow);
            if (PlaceInfoFoldableLayout.this.getLayoutParams() != null) {
                PlaceInfoFoldableLayout.this.getLayoutParams().height = mCoverHeight * 2;
            }
            requestLayout();
            mIsFolded = false;
        }
        ...
        if (!mIsAnimating) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    PlaceInfoFoldableLayout.this.getLayoutParams().height = (int) (initialHeight - initialHeight / 2 * animation.getAnimatedFraction());
                    PlaceInfoFoldableLayout.this.requestLayout();
                }
            });
        ...
        if (!mIsAnimating) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    PlaceInfoFoldableLayout.this.getLayoutParams().height = (int) (initialHeight + initialHeight * animation.getAnimatedFraction());
                    PlaceInfoFoldableLayout.this.requestLayout();
